...
bool Strategy1::play( std::shared_ptr<Board> board_, const Player* player, int32_t& i,
...
bool Strategy2::play( std::shared_ptr<Board> board_, const Player* player, int32_t& i,
                     int32_t& j, int32_t& i2, int32_t& j2 ) const{
...
// Ordered behavior
bool Strategy3::play( std::shared_ptr<Board> board_, const Player* player, int32_t& i,
                     int32_t& j, int32_t& i2, int32_t& j2 ) const{
